        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center" data-id="f4bcikiux" data-path="js/components/Hero.js">
          <div className="fade-in" data-id="2q34s3ztm" data-path="js/components/Hero.js">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight" data-id="xhvt6a67u" data-path="js/components/Hero.js">
              Junior AI<span className="gradient-text" data-id="ha07sb08t" data-path="js/components/Hero.js"> Product</span> Developer
            </h1>
          ...
          <div className="fade-in" style={{ animationDelay: '0.3s' }} data-id="24x3zznho" data-path="js/components/Hero.js">
            <div className="relative rounded-2xl overflow-hidden shadow-xl transform hover:scale-[1.02] transition-all duration-500" data-id="14sv9ttua" data-path="js/components/Hero.js">
              <img
                ...
                className="w-full h-[400px] object-cover" data-id="sf9vpjms8" data-path="js/components/Hero.js" />

              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/70 to-transparent text-white" data-id="anhov8zl3" data-path="js/components/Hero.js">
                <h3 className="text-xl font-semibold mb-2" data-id="fqrbmt974" data-path="js/components/Hero.js">Creative Solutions</h3>
                <p className="text-white/80" data-id="4vug1krer" data-path="js/components/Hero.js">Changing thoughts to reality through coding and developing</p>
              </div>
              
              <div className="absolute top-4 right-4 bg-white/90 rounded-full p-2 shadow-lg transform hover:rotate-12 transition-all cursor-pointer" data-id="wjagub1dv" data-path="js/components/Hero.js">
                <i className="fas fa-heart text-serene-500" data-id="25h9eucah" data-path="js/components/Hero.js"></i>
              </div>
            </div>
          </div>
        </div>

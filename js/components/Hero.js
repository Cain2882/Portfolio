        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href="C:/Users/Cain Antony/SCM/public/Cain Antony Resume.pdf" target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-transparent border-2 border-serene-300 text-serene-700 rounded-lg hover:bg-serene-50 transition-all flex items-center justify-center">
